                    ...
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 col-sm-12 mb-3"><input type="text" class="form-control"
                                    ...
                                    id="date" />
                                <input type="hidden"
                                    value="{{ request()->from ?? Carbon\Carbon::now()->format('d-m-Y') }}" name="from"
                                    id="from">
                                <input type="hidden" value="{{ request()->to ?? Carbon\Carbon::now()->format('d-m-Y') }}"
                                    name="to" id="to">
                            </div>
                            @push('scripts')
                                <script>
                            ...
                            <div class="col-xl-3 col-md-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-4 col-sm-4 mb-3"><a href="/report/export"
                                            class="btn btn-primary btn-block"><i class="fa-solid fa-file-export"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card border-left-secondary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="fa-solid fa-hands-holding fa-2x text-secondary"></i>
                            </div>
                        </div>
                    </div>
                </div>
